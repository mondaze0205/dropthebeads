		...
		<div class="pal_r">
			<table class="palette">
				<tr>
					...
					<td id="그린" style="background-color: #00ff00"></td>
					...
					<td id="레몬시폰" style="background-color: #fffacd"></td>		
				...
				<tr>
					...
					<td id="메드스프링그린" style="background-color: #00fa9a"></td>
				...
				<tr>	
					...
					<td id="라이트골든로드" style="background-color: #eedd82"></td>
				...
				<tr>
					...
					<td id="바이올렛레드" style="background-color: #d02090"></td>
					<td id="마젠타" style="background-color: #ff00ff"></td>
					...
					<td id="퍼플" style="background-color: #a020f0"></td>
